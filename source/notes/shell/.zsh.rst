...
* `zsh docs (14.1.4): Modifiers <http://zsh.sourceforge.net/Doc/Release/Expansion.html#Modifiers>`_
...
Parameter Expansion
-------------------
* `zsh docs (14.3.1): Parameter expansion flags <http://zsh.sourceforge.net/Doc/Release/Expansion.html#Parameter-Expansion-Flags>`_
...
Glob Qualifiers
---------------
* `zsh docs (14.8.7): Glob Qualifiers <http://zsh.sourceforge.net/Doc/Release/Expansion.html#Glob-Qualifiers>`_
